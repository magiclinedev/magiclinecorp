...
@section('title')
  {{ GoogleTranslate::trans('Admin | Categories', app()->getLocale()) }}
@endsection
@section('page-active')
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        ...
        <div class="row">
          <div class="col">
            <h3 class="card-title">{{ GoogleTranslate::trans('Categories', app()->getLocale()) }}</h3>
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <form method="post" class="form-group" id="trashform" action="{{route('trashcateg')}}">
        @csrf
        <div class="row">
          <div class="col-sm-2">
            <div class="input-group">
              <select class="form-control" name="action" aria-placeholder="Bulk Action">
                ...
                <option value="deletecateg" >Permanently Delete</option>
          ...
          <div><a href="{{route('addcategory')}}" class="btn btn-light ml-3"><i class="fa fa-user-plus"></i> {{ GoogleTranslate::trans('Add New Category', app()->getLocale()) }}</a></div>
        </div>
      ...
      <?php
        foreach ($categories as $categ) { ?>
          <tr>
            <td><input type="checkbox" value="{{$categ->id}}" name="checkbox[]"></td>
            <td><?php echo $categ->category; ?></td>
            <td><?php echo $categ->addedby.' on '.date("M-d-y", strtotime($categ->created_at)).' at '.date("H:i:s", strtotime($categ->created_at)); ?></td>
